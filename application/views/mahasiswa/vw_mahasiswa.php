    ...
    <aside
        ...
        <div class="sidenav-header">
            ...
            <a class="navbar-brand m-0" href=" https://demos.creative-tim.com/argon-dashboard/pages/dashboard.html "
                ...
                <span class="ms-1 font-weight-bold">Diana Dashboard</span>
            </a>
        </div>
        ...
        <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="<?=site_url('Prodi/')?>">
                        <div
                            class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="<?= site_url('Perpustakaan/')?>">
                        <div
                            class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                            <i class="ni ni-tv-2 text-primary text-sm opacity-10"></i>
                        </div>
                ...
                <tbody>
                    ...
                    <?php foreach($mahasiswa as $us) : ?>
                        <tr>
                            ...
                            <td><?=$us['email']; ?></td>
                            <td>
                            <a href="<?= base_url("Mahasiswa/hapus/") . $us['id'];?>" class="badge badge-danger"><font color="green">Hapus</font></a>
                            <a href="<?= base_url("Mahasiswa/edit/"). $us['id'];?> " class="badge badge-warning"><font color="green">Edit</font></a>
                            <a href="<?= base_url("Mahasiswa/detail/"). $us['id'];?>" class="badge badge-info"><font color="green">Detail </font></a>
                                </td>
                            </tr>
                        <?php $i++; ?>
                     <?php endforeach; ?>
