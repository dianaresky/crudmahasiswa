<body class="g-sidenav-show   bg-gray-100">
    ...
    <aside
        ...
        <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a class="nav-link active" href="<?= site_url('Mahasiswa/')?>">
                        <div
...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-md-6"><a href="<?= base_url()?>index.php/Perpustakaan/tambah" class="btn btn-info mb-2">Tambah Peminjaman</a></div>
        <div class="col-md-12">
