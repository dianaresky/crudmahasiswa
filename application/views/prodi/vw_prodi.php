            ...
            <table class="table" style="color: white;">
                ...
                <?php $i=1;?>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="<?= base_url("Prodi/hapus/"). $us['id'];?>" class="badge badge-danger"><font color="green">Hapus</font></a>
                            <a href="<?= base_url("Prodi/edit/"). $us['id'];?>" class="badge badge-warning"><font color="green">Edit</font></a>
                        </td>
                    </tr>
                    <?php $i++;?>
                    <?php endforeach; ?>
